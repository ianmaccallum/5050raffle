    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">50/50 Raffle</h1>
        ...
        {showHowItWorks && (
          <div className="mb-8 bg-blue-50 border border-blue-200 rounded p-6">
            <h2 className="text-xl font-bold mb-4">How the 50/50 Raffle Works</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-bold mb-2">1. Entry & Contributions</h3>
                <p>Participants can enter the raffle by contributing any amount. Each dollar contributed equals one entry in the raffle, increasing your chances of winning proportionally to your contribution.</p>
              </div>

              <div>
                <h3 className="font-bold mb-2">2. Prize Pool</h3>
                <p>The total amount collected is split 50/50:
                  <br />• 50% goes to the winning participant
                  <br />• 50% goes to the designated charity or cause</p>
              </div>

              <div>
                <h3 className="font-bold mb-2">3. Winner Selection</h3>
                <p>Winners are selected randomly, but fairly. Your chances of winning are directly proportional to your contribution amount. For example, if you contributed 20% of the total pool, you have a 20% chance of winning.</p>
              </div>

              <div>
                <h3 className="font-bold mb-2">4. Transparency</h3>
                <p>All entries are visible in the table below. The draw process is automated and random, ensuring complete fairness. Results show full statistics including the winner\&apos;s original contribution and winning chances.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {result && (
          <div className="bg-green-50 border border-green-200 rounded p-6">
            <h2 className="text-2xl font-bold mb-4">Raffle Results</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold mb-2">Summary</h3>
                <p>Total Amount Raised: ${result.totalAmount}</p>
                <p>Amount to Charity: ${result.charityAmount}</p>
                <p>Prize Amount: ${result.winnerAmount}</p>
              </div>
              <div>
                <h3 className="font-bold mb-2">Winner</h3>
                <p>Name: {result.winner.name}</p>
                {result.winner.email && <p>Email: {result.winner.email}</p>}
                {result.winner.phone && <p>Phone: {result.winner.phone}</p>}
                <p>Original Contribution: ${result.winner.originalContribution}</p>
                <p>Winning Chance: {result.winner.winningChancePercentage}%</p>
              </div>
            </div>
          </div>
        )}
